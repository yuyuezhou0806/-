...
def change_col3_data(driver, i, col3_data,):
    ...
    driver.find_element(By.XPATH,
                        '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[1]/div/div/div/div/div/div/button').click()
    # 17，点击空白框
    time.sleep(1)
    ...
    if i > 30 and i <= 60:
        # 人数超过30点击两次下一页
        driver.find_element(By.XPATH,
                            '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[5]/div/div/div[2]/div/nz-pagination/ul/li[4]/a').click()
        time.sleep(1)
    elif i > 60:
        # 人数超过60点击一次下一页
        driver.find_element(By.XPATH,
                            '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[5]/div/div/div[2]/div/nz-pagination/ul/li[5]').click()
    # 19，选择人
    time.sleep(2)
    page_i = i
    while page_i > 30:
...
def main_point(project_num, workload, col3_data,Labor_fees):
    """
    :param project_num:项目编号
    :param workload:需汇报工作量
    :param col3_data:人工工时
    :param Labor_fees:劳务费
    :return: 布尔型，返回运行结果
    """
    try:
        ...
        if Labor_fees <= 0:
            driver.find_element(By.XPATH,
                                '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[18]/div/div/div/div/div/div/div/nz-form-control/div/span/nz-select/div/div/div[1]').click()
            time.sleep(1)
            ...
            time.sleep(1)
            driver.find_element(By.XPATH,'/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[1]/div/div/div/div/div[1]/div[2]').click()
            time.sleep(1)
            driver.find_element(By.XPATH,'/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[2]/div/div/div/div/div/div/button').click()
            time.sleep(1)
            driver.find_element(By.XPATH,'/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[2]/div/div/div/div/div/div/nz-table/nz-spin/div/div/div/div/div/table/tbody/tr/td[2]/div/div').click()
            time.sleep(1)
            driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[2]/div/div/div/div/div/div/nz-table/nz-spin/div/div/div/div/div/table/tbody/tr/td[2]/nz-input-group/span/span[2]').click()
            time.sleep(1)
            driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[5]/div/div/div[2]/nz-table/nz-spin/div/div/div/div/div[2]/table/tbody/tr[1]/td[2]').click()
            time.sleep(1)
            driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[5]/div/div/div[3]/button[1]').click()
            time.sleep(1)
            driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[2]/div/div/div/div/div/div/nz-table/nz-spin/div/div/div/div/div/table/tbody/tr/td[4]/div/div').click()
            driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[2]/div/div/div/div/div/div/nz-table/nz-spin/div/div/div/div/div/table/tbody/tr/td[4]/nz-input-number/div[2]/input').click()
            driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[2]/div[2]/div/div/div/div/div/div/nz-table/nz-spin/div/div/div/div/div/table/tbody/tr/td[4]/nz-input-number/div[2]/input').send_keys(Labor_fees)
        time.sleep(1)
        # 16，新增数据
        time.sleep(1)
        driver.find_element(By.XPATH, "/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[17]/div/div/div/div/div/div/div/nz-form-control/div/span/textarea").click()
        time.sleep(1)
        driver.find_element(By.XPATH, "/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[17]/div/div/div/div/div/div/div/nz-form-control/div/span/textarea").send_keys("项目在建中")
        # 新增一条数据
        driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[19]/div/div/div/div/div/nz-tabset/div[1]/div/div/div/div/div[1]/div[1]').click()
        time.sleep(1)
        ...
        time.sleep(1)
        el = driver.find_element(By.XPATH, '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[22]/div/div/div/nz-form-control/div/span/div[1]/div[1]/div/nz-upload/div/div/input')
        el.send_keys(r"C:\Users\admin\PyCharmMiscProject\5月工作量签单(1).pdf")
        time.sleep(10)
        # 23，审核ZCHJC003869
...
def yyz_main(main_excel_name):
    ...
    for i in range(2, test_num + 2):
        ...
        Labor_fees = sheet.cell(row=i, column=4).value
        print('共{}条数据'.format(test_num))
        start_log = 'No:{},project_num:{},workload:{}'.format(i - 1, project_num, workload, time.strftime('%Y-%m-%d %H:%M:%S'))
        print(start_log)
        write_log_data(log_file_name, start_log)
        flag = main_point(project_num, workload, col3_data,Labor_fees)
        if flag:
            print('success')
