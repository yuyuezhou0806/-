...
def main_point(project_num, workload):
    ...
    try:
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,'/html/body/div[3]/div[5]/div/div/date-range-popup/div/div/div/div/inner-popup/calendar-header/div/year-panel/div/div/div[2]/table/tbody/tr[3]/td[1]/a').click()
        time.sleep(1)
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,'/html/body/div[3]/div[5]/div/div/date-range-popup/div/div/div/div/inner-popup/div/date-table/table/tbody/tr[5]/td[3]/div').click()
        time.sleep(1)
        # 17,抓取调整天数
        ...
        el.send_keys(r"C:\Users\admin\PyCharmMiscProject\11.25延期.pdf")
        time.sleep(5)
        # 23，审核
