...
def main_point(project_num, workload):
    ...
    try:
        ...
        time.sleep(1)
        # 选择月份
        driver.find_element(By.XPATH,'/html/body/div[3]/div[5]/div/div/date-range-popup/div/div/div/div/inner-popup/calendar-header/div/month-panel/div/div/div[2]/month-table/table/tbody/tr[2]/td[3]/a').click()
        time.sleep(1)
        driver.find_element(By.XPATH,'/html/body/div[3]/div[5]/div/div/date-range-popup/div/div/div/div/inner-popup/div/date-table/table/tbody/tr[5]/td[2]/div').click()
        time.sleep(1)
        # 17,抓取调整天数
