...
def change_col3_data(driver, i, col3_data):
    time.sleep(1)
    driver.find_element(By.XPATH,'//*[@id="body"]/div[2]/div/form/div[17]/div/div/div/div/div/nz-tabset/div[2]/div[1]/div/div/div/div/div/div/button').click()
    # 17，点击空白框
    time.sleep(1)
    ...
    time.sleep(1)
    driver.find_element(By.XPATH,'//*[@id="body"]/div/nz-pagination/ul/div/nz-select/div/div/div').click()
    time.sleep(1)
...
def main_point(project_num, workload, col3_data):
    ...
    try:
        ...
        el.send_keys(r"C:\Users\admin\PyCharmMiscProject\2025年12月工作量附件.pdf")
        time.sleep(5)
        # 23，审核ZCHJC003869
