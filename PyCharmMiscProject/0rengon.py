...
def main_point(project_num, workload):
    ...
    try:
        ...
        driver.find_element(By.XPATH,
                            "/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[17]/div/div/div/div/div/div/div/nz-form-control/div/span/textarea").click()
        time.sleep(1)
        driver.find_element(By.XPATH,
                            "/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[17]/div/div/div/div/div/div/div/nz-form-control/div/span/textarea").send_keys(
            "项目在建中")
        # 新增一条数据
        time.sleep(1)
        #选择无劳务费
        ...
        el = driver.find_element(By.XPATH,
                                 '/html/body/app-root/layout-default/section/app-inventory/div/div/define-project/form-preview/pop-window[1]/div/div/div[2]/div[2]/div/form/div[22]/div/div/div/nz-form-control/div/span/div[1]/div[1]/div/nz-upload/div/div/input')
...
def yyz_main(main_excel_name):
    ...
    for i in range(2, test_num + 2):
        ...
        start_log = 'No:{},project_num:{},workload:{},start_time:{}'.format(i - 1, project_num, workload,
